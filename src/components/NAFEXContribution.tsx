...
interface NAFEXContributionProps {
  bankName: string;
...
const NAFEXContribution: React.FC<NAFEXContributionProps> = ({
  bankName,
  contributionDate
}) => {
  ...
  const [contributionRecords, setContributionRecords] = useState<ContributionRecord[]>([
    {
      ref: '192692',
      contributionDate: '2024-10-02',
      midRate: '360.50',
      authoriser: 'deinma.iyagba@ubagroup.com',
      inputDate: '2024-10-02 11:39:41 AM',
      status: 'contribution'
    }
  ]);
  ...
  const handleSubmit = () => {
    if (midRate && selectedAuthoriser) {
      const newRecord: ContributionRecord = {
        ref: (Math.floor(Math.random() * 100000) + 100000).toString(),
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">NAFEX Contribution</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <div>
            ...
            >
              ...
              <option value="deinma.iyagba@ubagroup.com">deinma.iyagba@ubagroup.com</option>
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <div className="px-3 py-2 bg-gray-50 border border-gray-200 rounded-md text-sm text-gray-900">
                  {selectedRecord.contributionDate}
                </div>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-6">
                Click OK to send your NAFEX Contribution for approval.
              </p>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-6">
                Your NAFEX Contribution has been sent to the Authoriser.
              </p>
...
export default NAFEXContribution;