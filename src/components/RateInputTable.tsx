...
interface RateInputTableProps {
  contributionType: string;
  bankName: string;
  contributionDate: string;
}

const RateInputTable: React.FC<RateInputTableProps> = ({
  contributionType,
  bankName,
  contributionDate
}) => {
  ...
  const [contributionRecords, setContributionRecords] = useState<ContributionRecord[]>([
    ...
    },
    {
      ...
      bidRate: '1600.80',
      offerRate: '1650.50',
      authoriser: 'olukemi.akintoye@ubagroup.com',
      inputDate: '2025-08-02 11:39:41 AM',
      status: 'contribution'
    }
  ]);
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-gray-900 mb-2">
          {contributionType} Contribution Details
        </h2>
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-6">
                Click OK to send your NIBOR Contribution for approval.
              </p>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-6">
                Your NIBOR Contribution has been sent to the Authoriser.
              </p>
